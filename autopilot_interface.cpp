	...
	while (!received_all and !time_to_exit)
	{
		...
		if (success)
		{
			...
			case MAVLINK_MSG_ID_HEARTBEAT:
			{
				...
				printf("Heartbeat\n");
				printf("%s %s %s %s %s %s %s %s \n", VariableName(sysid), VariableName(compid), VariableName(custom_mode), VariableName(type), VariableName(autopilot), VariableName(base_mode), VariableName(system_status), VariableName(mavlink_version));
				printf("%d        %d           %d          %d        %d  	 %d            %d                  %d       \n\n",
					   current_messages.sysid, current_messages.compid, current_messages.heartbeat.custom_mode, current_messages.heartbeat.type, current_messages.heartbeat.autopilot, current_messages.heartbeat.base_mode, current_messages.heartbeat.system_status, current_messages.heartbeat.mavlink_version);
